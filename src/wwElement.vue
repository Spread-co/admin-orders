...
:global(html.dark) .spread-ao__filter-btn--active { background: #4b162d; border-color: #4b162d; color: #f5f0eb; }
:global(html.dark) .spread-ao__search { background: #160c11; border-color: rgba(230,216,202,0.2); color: #f5f0eb; }
